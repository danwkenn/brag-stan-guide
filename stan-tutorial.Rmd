...
This is a well known example for Stan users.  We use this example here to illustrate  two things. First, to use the Stan program to *generate data from the model*, which may be used for prior predictive analysis or to validate the probablistic model. Second,  to study the effect of  *centered* and *non-centered* parametrisation  of the model  on MCMC diagnostics. 
